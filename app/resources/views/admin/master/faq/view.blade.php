                            ...
                            <div class="card-header text-center">
                                <div class="form-row align-items-center">
                                    ...
                                    <div class="col-md-4 my-2 text-right text-md-right">
                                        @if ($crud['restore'] == 1)
                                            <a href="{{ url('/') }}/admin/master/faq/restore"
                                                class="btn  btn-outline-dark btn-sm  mr-10" type="button">Restore</a>
                                        @endif
                                        @if ($crud['add'] == 1)
                                            <a href="{{ url('/') }}/admin/master/faq/create"
                            ...
                            <div class="card-body ">
                                <div class="row">
                                    <div class="col-12 col-sm-12">
                                        <table class="table table-sm" id="tblFaq">
                                            <thead>
                                                <tr>
    ...
    <script>
        $(document).ready(function() {
            const LoadTable = async () => {
                @if ($crud['view'] == 1)
                    $('#tblFaq').dataTable({
                        ...
                        "bServerSide": true,
                        "ajax": {
                            "url": "{{ url('/') }}/admin/master/faq/data?_token=" + $(
            ...
            $(document).on('click', '.btnEdit', function() {
                window.location.replace("{{ url('/') }}/admin/master/faq/edit/" + $(this).attr(
                    'data-id'));
            });
            $(document).on('click', '.btnDelete', function(e) {
                ...
                swal({
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('/') }}/admin/master/faq/delete/" + id,
