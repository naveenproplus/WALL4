                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <div class="col-sm-4">
                                        <input type="file" id="txtProfileImage" class="dropify"
                                            data-max-file-size="{{ $Settings['upload-limit'] }}"
                                            data-default-file="<?php if ($isEdit == true) {
                                                if ($EditData[0]->ProfileImage != '') {
                                                    echo url('/') . '/' . $EditData[0]->ProfileImage;
                                                }
                                            } ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txtName" class="form-control"
                                                placeholder="Name" value="<?php if ($isEdit == true) {
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="txtEmail" class="form-control"
                                                placeholder="E-Mail" value="<?php if ($isEdit == true) {
                                                    echo $EditData[0]->EMail;
                                                } ?>">
                ...
                if (status) {
                    ...
                    swal({
                        ...
                        function() {
                            ...
                            @if ($isEdit)
                                let posturl =
                                    "{{ url('/') }}/admin/master/clients/edit/{{ $ClientID }}";
                            @else
                                let posturl =
                                    "{{ url('/') }}/admin/master/clients/create";
                            @endif
                            $.ajax({
                                type: "post",
                                url: posturl,
