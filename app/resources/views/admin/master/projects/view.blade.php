                            ...
                            <div class="card-header text-center">
                                <div class="form-row align-items-center">
                                    ...
                                    <div class="col-md-4 my-2 text-right text-md-right">
                                        @if ($crud['restore'] == 1)
                                            <a href="{{ url('/') }}/admin/master/projects/restore"
    ...
    <script>
        $(document).ready(function() {
            const LoadTable = async () => {
                @if ($crud['view'] == 1)
                    $('#tblProjects').dataTable({
                        ...
                        "bServerSide": true,
                        "ajax": {
                            "url": "{{ url('/') }}/admin/master/projects/data?_token=" + $(
            ...
            $(document).on('click', '.btnEdit', function() {
                window.location.replace("{{ url('/') }}/admin/master/projects/edit/" + $(this).attr(
                    'data-id'));
            });
            $(document).on('click', '.btnDelete', function(e) {
                ...
                swal({
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('/') }}/admin/master/projects/delete/" + id,
