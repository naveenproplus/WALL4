                            ...
                            <div class="card-header text-center">
                                <div class="form-row align-items-center">
                                    ...
                                    <div class="col-md-4 my-2 text-right text-md-right">
                                        @if ($crud['restore'] == 1)
                                            <a href="{{ url('/') }}/admin/master/project-area/restore"
    ...
    <script>
        $(document).ready(function() {
            const LoadTable = async () => {
                @if ($crud['view'] == 1)
                    $('#tblProjectArea').dataTable({
                        ...
                        "bServerSide": true,
                        "ajax": {
                            "url": "{{ url('/') }}/admin/master/project-area/data?_token=" + $(
            ...
            $(document).on('click', '.btnEdit', function() {
                window.location.replace("{{ url('/') }}/admin/master/project-area/edit/" + $(this)
                    .attr('data-id'));
            });
            $(document).on('click', '.btnDelete', function(e) {
                ...
                swal({
                    title: "Are you sure?",
                    text: "You want to Delete this Project Area!",
                    type: "warning",
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('/') }}/admin/master/project-area/delete/" + id,
