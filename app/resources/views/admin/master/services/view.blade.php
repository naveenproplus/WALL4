                            ...
                            <div class="card-header text-center">
                                <div class="form-row align-items-center">
                                    ...
                                    <div class="col-md-4 my-2 text-right text-md-right">
                                        @if ($crud['restore'] == 1)
                                            <a href="{{ url('/') }}/admin/master/services/restore"
                                                class="btn  btn-outline-dark btn-sm   mr-10" type="button">Restore</a>
                                        @endif
                                        @if ($crud['add'] == 1)
                                            <a href="{{ url('/') }}/admin/master/services/create"
    ...
    <script>
        $(document).ready(function() {
            const LoadTable = async () => {
                @if ($crud['view'] == 1)
                    $('#tblServices').dataTable({
                        ...
                        "bServerSide": true,
                        "ajax": {
                            "url": "{{ url('/') }}/admin/master/services/data?_token=" + $(
            ...
            $(document).on('click', '.btnEdit', function() {
                window.location.replace("{{ url('/') }}/admin/master/services/edit/" + $(this).attr(
                    'data-id'));
            });
