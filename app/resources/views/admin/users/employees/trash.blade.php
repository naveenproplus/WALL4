						...
						<div class="card-header text-center">
							<div class="form-row align-items-center">
								...
								<div class="col-md-4 my-2 text-right text-md-right">
									@if($crud['view']==1)
										<a href="{{ url('/') }}/admin/users-and-permissions/employees/" class="btn  btn-outline-dark btn-sm  mr-10" type="button" >Back</a>
									@elseif($crud['add']==1)
										<a href="{{ url('/') }}/admin/users-and-permissions/employees/create" class="btn  btn-outline-success btn-sm btn-air-success " type="button" >Back</a>
									@endif
								</div>
							</div>
						</div>
    ...
    $(document).ready(function(){
        const LoadTable=async()=>{
			...
			$('#tblUsers').dataTable( {
				"bProcessing": true,
				"bServerSide": true,
                "ajax": {"url": "{{url('/')}}/admin/users-and-permissions/employees/restore-data?_token="+$('meta[name=_token]').attr('content'),"headers":{ 'X-CSRF-Token' : $('meta[name=_token]').attr('content') } ,"type": "POST"},
				deferRender: true,
				responsive: true,
				dom: 'Bfrtip',
				"iDisplayLength": 10,
        ...
        $(document).on('click','.btnRestore',function(e){
            ...
            swal({
                ...
                $.ajax({
                    ...
                    url: "{{url('/')}}/admin/users-and-permissions/employees/restore/"+ id,
