		...
		<div class="row">
			<div class="col-sm-12">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="{{ url('/') }}/admin/enquiry/contact">{{$PageTitle}}</a></li>
						...
						<div class="card-header text-center">
							<div class="form-row align-items-center">
								...
								<div class="col-md-4 my-2 text-right text-md-right">
									@if($crud['view']==1)
										<a href="{{ url('/') }}/admin/enquiry/contact-us" class="btn  btn-outline-dark btn-sm  full-right mr-10" type="button" >Back</a>
									@endif
								</div>
							</div>
						</div>
    ...
    $(document).ready(function(){
        const LoadTable=async()=>{
			...
			$('#tblEnquiry').dataTable( {
				"bProcessing": true,
				"bServerSide": true,
                "ajax": {"url": "{{url('/')}}/admin/enquiry/contact-us/restore-data?_token="+$('meta[name=_token]').attr('content'),"headers":{ 'X-CSRF-Token' : $('meta[name=_token]').attr('content') } ,"type": "POST"},
				deferRender: true,
				responsive: true,
				dom: 'Bfrtip',
				"iDisplayLength": 10,
        ...
        $(document).on('click','.btnRestore',function(e){
            ...
            swal({
                title: "Are you sure?",
                text: "You want to Restore this enquiry!",
                type: "warning",
                ...
                $.ajax({
                    ...
                    url: "{{url('/')}}/admin/enquiry/contact-us/restore/"+ id,
