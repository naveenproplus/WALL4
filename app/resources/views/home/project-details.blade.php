...
<!-- Banner  -->
	<div class="slidearea bannerside">
		...
		<div class="dz-bnr-inr style-1 overlay-left edit-content" id="img-services-bnr" style="background-image:url({{url('/')}}/{{$Project->ProjectImage}});">
...
<section class="section-full content-inner-2 port-detail" style="background-image:url({{url('/')}}/assets/home/images/background/bg2.png); background-position:right bottom; background-size:100%; background-repeat:no-repeat;">
    <div class="container">
    ...
    <div class="container">
        <div class="row lightgallery">
            ...
            @foreach ($Project->ProjectGallery as $item)
                <div class="col-lg-4 col-md-4 m-b30 aos-item" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                    <div class="dz-box overlay style-1">
                        <div class="dz-media">
                            <img src="{{url('/')}}/{{$item}}" alt="">
                        </div>
                        <div class="dz-info">
                            <span data-exthumbimage="{{url('/')}}/{{$item}}" data-src="{{url('/')}}/{{$item}}" class="view-btn lightimg" title="{{$Project->Slug}}"></span>
                        </div>
                    </div>	
                </div>
            @endforeach
