...
if ((localStorage.getItem("sidebar-layout") != null)&&(localStorage.getItem("sidebar-layout") !=undefined )) {
    $("body").attr("class", localStorage.getItem("sidebar-layout") );
}
