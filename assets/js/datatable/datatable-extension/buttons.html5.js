...
var _exportData = function ( dt, config )
{
	...
	let footerMatrix = _fnGetFooters(dt);
	let ft="";
	for ( let rowIdx = 0;  rowIdx < footerMatrix.length;  rowIdx++ ) {
        ft+= newLine+join( footerMatrix[rowIdx] );
    }
	var header = config.header ? join( data.header )+newLine : '';
	var footer = config.footer && data.footer ? ft : '';
	var body = [];
...
var _fnGetFooters = function(dt) {console.log(dt);
