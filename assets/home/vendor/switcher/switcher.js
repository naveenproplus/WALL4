	...
	var dzSwitcher = `<div id="dzSwitcher-right" class="styleswitcher">
						...
						<div class="styleswitcher-inner">
							...
							<div class="theme-design row">
								<input type="text" id="txtMobNo" class="form-control" placeholder="Name *">
							</div>
							<div class="theme-design row theme-layout-wrapper">
								<input type="number" id="txtMobNo" class="form-control" placeholder="Mobile No *">
							</div>
							<div class="theme-design row theme-view-wrapper">
								<input type="text" id="txtMobNo" class="form-control" placeholder="Email *">
							</div>
							<div class="theme-design row mb-0 theme-background-wrapper">
								<!-- Theme background content here -->
							</div>
						</div>
					</div>`;
